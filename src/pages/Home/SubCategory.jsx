...
const SubCategory = () => {
  return (
    <div data-aos="fade-up">
      <h2 className="text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 via-cyan-500 to-blue-500 text-center my-4">
        Search by Category
      </h2>
      <Tabs classID="bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 via-cyan-500 to-blue-500">
        <TabList>
          <Tab>FootBall</Tab>
          <Tab>Cricket</Tab>
        ...
        <TabPanel>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="card lg:card-side bg-gradient-to-b from-violet-400 via-indigo-500 to-blue-600 shadow-xl p-4">
              <figure>
                <img
